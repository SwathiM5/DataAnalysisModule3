...
select o.order_id, o.status, sum(io.quantity) as total_items from orders o join order_items io on o.order_id = io.order_id group by o.order_id, o.status;
-- Q8) Show orders placed on '2025-09-04' (any time that day).
select * from orders where order_datetime = '2025-09-04';
